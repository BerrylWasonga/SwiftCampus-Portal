...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2026 at 12:29 PM
...
INSERT INTO `course_units` (`id`, `unit_code`, `unit_name`, `description`, `credit_hours`, `unit_type`, `status`, `created_at`) VALUES
(1, 'COSC 101', 'Introduction to Computer Science', 'Basics of CS', 3, 'core', 'active', '2026-01-23 11:41:08'),
(2, 'COSC 102', 'Programming Fundamentals', 'Intro to Programming in C', 3, 'core', 'active', '2026-01-23 11:41:08'),
(3, 'MATH 101', 'Calculus I', 'Differential Calculus', 3, 'core', 'active', '2026-01-23 11:41:08');
...
(1, 1, 1, 1, 1, 1, '2026-01-23 11:41:08'),
(2, 1, 2, 1, 1, 1, '2026-01-23 11:41:08'),
(3, 1, 3, 1, 1, 1, '2026-01-23 11:41:08');
...
INSERT INTO `registration_windows` (`id`, `semester_id`, `registration_type`, `start_datetime`, `end_datetime`, `status`, `created_at`) VALUES
(1, 2, 'regular', '2026-01-01 00:00:00', '2026-02-28 23:59:59', 'open', '2026-01-23 11:41:08');
...
INSERT INTO `student_academic_info` (`id`, `user_id`, `current_year_of_study`, `current_semester_of_study`, `academic_year_id`, `updated_at`) VALUES
(1, 1, 4, 1, 1, '2026-01-23 11:41:07'),
(2, 10, 4, 1, 1, '2026-01-23 11:41:07');
...
INSERT INTO `student_documents` (`id`, `user_id`, `document_name`, `file_path`, `remarks`, `created_at`) VALUES
(2, 1, 'Paulo Coelho - The Pilgrimage (v5.0)', 'uploads/documents/1769169313_Paulo_Coelho___The_Pilgrimage__v5_0_.pdf', 'Try read it', '2026-01-23 11:55:13');
